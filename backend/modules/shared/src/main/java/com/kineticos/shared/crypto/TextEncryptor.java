package com.kineticos.shared.crypto;
 ...
 * La clave configurada ({@code kineticos.security.encryption-key}) se hashea con
...
public class TextEncryptor {
    ...
    public TextEncryptor(@Value("${kineticos.security.encryption-key:}") String secret) {
        if (secret == null || secret.isBlank()) {
            throw new IllegalStateException(
                    "kineticos.security.encryption-key (env ENCRYPTION_KEY) no está configurada");
        }
