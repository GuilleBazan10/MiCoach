package com.micoach.user.presentation;

import com.micoach.shared.security.AuthenticatedUser;
import com.micoach.user.application.port.in.UserProfileUseCase;
import com.micoach.user.application.port.in.UserProfileUseCase.GoalData;
import com.micoach.user.application.port.in.UserProfileUseCase.InjuryData;
import com.micoach.user.application.port.in.UserProfileUseCase.MedicationData;
import com.micoach.user.application.port.in.UserProfileUseCase.PathologyData;
import com.micoach.user.application.port.in.UserProfileUseCase.ProfileUpdate;
import com.micoach.user.presentation.UserDtos.GoalRequest;
import com.micoach.user.presentation.UserDtos.GoalResponse;
import com.micoach.user.presentation.UserDtos.InjuryRequest;
import com.micoach.user.presentation.UserDtos.InjuryResponse;
import com.micoach.user.presentation.UserDtos.MedicationRequest;
import com.micoach.user.presentation.UserDtos.MedicationResponse;
import com.micoach.user.presentation.UserDtos.PathologyRequest;
import com.micoach.user.presentation.UserDtos.PathologyResponse;
import com.micoach.user.presentation.UserDtos.ProfileResponse;
import com.micoach.user.presentation.UserDtos.ProfileUpdateRequest;
